...
| **sandbox** <br> [![sandbox](docs/sandbox.png)](docs/sandbox.png) | A world you build by hand — click an edge to raise a wall, a corner to stack beepers — or edit as JSON beside the canvas. Open and save both formats; they are the same files the extension opens and the CLI grades.                                               |
