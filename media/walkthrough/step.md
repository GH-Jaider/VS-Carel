...
Press **F10** to execute exactly one instruction.

- The **current line is highlighted** in your code.
- The world updates **in sync** with that line.
- Keep pressing F10 to follow loops and conditions decision by decision.
